        ...
        <Row>
          <Col xs={12}>
            <Text className={styles.RegisterSuccess__Body} domElement="p">
              <FormattedMessage {...messages.body} values={{ email: user.email }} />
            </Text>
          </Col>
        </Row>
        <Row>
          <Col xs={6} sm={4}>
            <GreenButton className={styles.RegisterSuccess__Continue} linkTo="/register/user-infos" message={messages.continue} />
          </Col>
        </Row>
      </Box>
    )}
