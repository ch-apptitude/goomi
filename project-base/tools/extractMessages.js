...
import { readFile, writeFile, glob } from './fs';
import config from '../src/universal/appConfig';

const GLOB_PATTERN = 'src/universal/features/**/*.{js,jsx}';
...
async function mergeToFile(locale, toBuild) {
  const fileName = `src/universal/features/language/translations/${locale}.json`;
