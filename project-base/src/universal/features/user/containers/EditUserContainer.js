...
class EditUserContainer extends Component {
  ...
  render() {
    ...
    const sendConfirmParams = { show: !this.props.user.isVerified, func: this.sendNewConfirmEmail };
    return <UserDetailsForm defaultValues={defaultValues} onSubmit={this.updateUser} sendNewConfirmEmail={sendConfirmParams} />;
  }
}
